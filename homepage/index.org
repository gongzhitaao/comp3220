...
** Late Work Policy
   :PROPERTIES:
   :CUSTOM_ID: sec:late-work-policy
   :END:
...
* Credit
  ...
  Notes on Compiler optimization on associativity is adpated from
  ...
  adpated from \cite{r6rs}\cite{sitaram2015}.  Equality predicates
